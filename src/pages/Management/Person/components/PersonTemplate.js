            ...
            type === 0 ? (
              <div className={styles.download}>
                ...
                <div className={styles.stapOne}>
                  <p className={styles.stapTitle}>
                    <font>2</font>
                    <FormattedMessage id="person.import.person" />
                  </p>
                  <p className={styles.stapText}>
                    <font>·</font>
                    {' '}
                    <FormattedMessage id="person.import.supported-file-type" />
                    <font>：xls，xlsx</font>
                  </p>
                  <p className={styles.stapText}>
                    <font>·</font>
                    {' '}
                    <FormattedMessage id="person.import.max-amount" />
                  </p>
                  <p className={styles.stapText}>
                    <font>·</font>
                    {' '}
                    <FormattedMessage id="person.import.error" />
                  </p>
                  <Upload {...props}>
